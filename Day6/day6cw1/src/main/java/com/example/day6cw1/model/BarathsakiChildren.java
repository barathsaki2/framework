...
@Entity
public class BarathsakiChildren {
    @Id
    private int babyId;
    ...
    public BarathsakiChildren() {
    }
    public BarathsakiChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
            String address) {
        this.babyId = babyId;
