...
@Entity
public class BarathsakiVillage {
    @Id
    ...
    public BarathsakiVillage(){}
    public BarathsakiVillage(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
